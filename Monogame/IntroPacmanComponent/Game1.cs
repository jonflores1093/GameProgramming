...
namespace IntroPacManComponent
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        public Game1()
        {
            ...
            //Add Food Manager to sow down frame rate
            fm = new FoodManager(this);

            //FPS component with framerate locked to 60
            //fps = new FPS(this);
            //FPS component with framerate unlocked to 60
            fps = new FPS(this, false, false);
