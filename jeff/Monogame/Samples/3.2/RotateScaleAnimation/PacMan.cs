...
{
    public class PacMan : DrawableAnimatableSprite2
    {
        ...
        {
            PacManMoving = new SpriteAnimation("PacManMoving", "PacManTwo_sm", 5, 2, 1);
            ...
            //Huh 4 is form the current animation adatper frame size
            this.Orgin = new Vector2(this.spriteTexture.Width / 4 , this.spriteTexture.Height / 2);
