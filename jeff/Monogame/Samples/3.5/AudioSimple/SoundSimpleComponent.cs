...
namespace AudioSimple
{
    /// <summary>
    /// Simple Sound Demos Use of KeyMaps to control and play sounds
    /// </summary>
    class SoundSimpleComponent : GameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            MediaPlayer.Volume = .5f;   //set starting volume
            ...
            outText = getOutText(); //text for console
        ...
        /// <summary>
        /// Turns Keymap into string to be used for logging or console.
        /// </summary>
        /// <returns></returns>
