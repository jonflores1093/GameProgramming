...
namespace EventsSimple
{
    ...
    public class Food : DrawableSprite
    {
        ...
        public event FoodHitEventHandler FoodHit;
        public event FoodHitEventHandler FoodHitTimeOut;

        // Invoke the FoodHitHit event;
        public virtual void OnFoodHit(EventArgs e)
        {
            if (FoodHit != null)
                FoodHit(this, e);
        }
        ...
        public void Hit()
        {
            ...
            this.Enabled = false;
            foodTimer.Start();
            this.OnFoodHit(EventArgs.Empty);
        ...
        internal void AddGhostHitEvents(Ghost ghost)
        {
            this.FoodHit += new FoodHitEventHandler(ghost.OnFoodHit);
            this.FoodHitTimeOut += new FoodHitEventHandler(ghost.OnFoodHitTimeOut);
        }
    }
}
