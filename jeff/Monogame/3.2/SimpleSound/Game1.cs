...
namespace SimpleSound4
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            soundEffect = Content.Load<SoundEffect>("pacchomp");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (kbs.IsKeyDown(Keys.I))
            {
                if (soundEffectIntance.State == SoundState.Stopped)
                {
                    //soundEffectIntance.Pan = (float)Math.Sin(panCounter);
                    soundEffectIntance.Pitch = -.5f;
                    soundEffectIntance.Play();
                    
                    //pan sound
                    //panCounter += 5;
                    //if (panCounter > 360) panCounter -= 360;
                }
            }
